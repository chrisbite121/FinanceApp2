...
export class LogService {
    ...
    log(desc:any, type:string = this.utilsService.infoStatus, verbose:boolean = false){
        ...
        if ((_useLoggingList  && _persist && _loggingListReady && _verbose)
            ||
            (_useLoggingList && _persist && _loggingListReady && !_verbose && verbose == false))  {
